    ...
    <div className="w-5/6 h-full flex flex-col bg-background">
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="grid grid-cols-3 gap-6 mb-8">
          ...
          <div className="p-6 bg-gradient-to-br tracking-in-expand from-blue-500/10 to-blue-500/5 border border-blue-500/20 rounded-lg hover:border-blue-500/40 transition-colors">
          ...
          <div className="p-6 bg-gradient-to-br tracking-in-expand from-green-500/10 to-green-500/5 border border-green-500/20 rounded-lg hover:border-green-500/40 transition-colors">
            <div className="flex items-center justify-between mb-4">
          ...
          {/* Login Activity Card */}
          <div className="p-6 bg-gradient-to-br tracking-in-expand from-purple-500/10 to-purple-500/5 border border-purple-500/20 rounded-lg hover:border-purple-500/40 transition-colors">
            <div className="flex items-center justify-between mb-4">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="p-6 bg-foreground/5 border border-foreground/10 rounded-lg">
            ...
            {vaultEntries.length === 0 ? (
              ...
              <div className="space-y-3 slide-in-blurred-right">
