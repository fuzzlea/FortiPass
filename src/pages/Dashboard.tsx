    ...
    return (<>
        ...
        <div className="w-full h-screen items-center px-8 pt-14">
            ...
            <div className="w-full h-[70svh] flex flex-row items-center">
                ...
                <div className="h-3/4 aspect-square bg-foreground/10 rounded-lg outline-1 outline-foreground/25 flex flex-col p-8 gap-2 justify-center">

                    <p className="mb-auto text-md italic">Welcome Back,<br /><span className="text-2xl font-bold">{currentUser ? currentUser.user : 'Name'}</span></p>

                    <p className="text-2xl font-bold" >0 <span className="text-lg font-normal">Passwords</span></p>
                    <p className="text-2xl font-bold" >0 <span className="text-lg font-normal">Issues</span></p>
                    <p className="text-2xl font-bold" >3 <span className="text-lg font-normal">Logins</span></p>
